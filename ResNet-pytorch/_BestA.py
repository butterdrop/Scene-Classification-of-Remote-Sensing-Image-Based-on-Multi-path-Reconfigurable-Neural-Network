...
from model.BestA import *
from model.resnets import resnet34
...
if __name__ == "__main__":
    classes_path = 'dataset/cls_classes (7).txt'
    cuda = True
    logs_dir = 'logs'
    dp = False
    input_shape = [200, 200]
    ...
    train_annotation_path = "images/RSSCN7_images/cls_train.txt"
    test_annotation_path = "images/RSSCN7_images/cls_test.txt"
...
# =================================================================================#
    pretrained_dict = torch.load('pths/BestA.pth')
    model=BestA()  # 确保此处与您的模型架构一致
    # 读取参数
