...
if __name__ == "__main__":
    classes_path = 'dataset/cls_classes (45).txt'
    cuda = True
    logs_dir = 'logs'
    dp = False
    input_shape = [256, 256]
    ...
    train_annotation_path = "images/NWPU-RESISC45_images/cls_train.txt"
    test_annotation_path = "images/NWPU-RESISC45_images/cls_test.txt"
...
# =================================================================================#
    pretrained_dict = torch.load('pths/BestC.pth')
    model =BestC()  # 确保此处与您的模型架构一致
    # 读取参数
