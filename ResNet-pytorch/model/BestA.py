...
class ResNet(nn.Module):
    ...
    def __init__(self,
        ...
        self.layer = self._connect_layer()
    ...
    def _connect_layer(self):
        ...
        self.in_channel = 256
        return conv_layer3  # 不必再包裹一层 nn.Sequential
...
def BestA(num_classes=1000, include_top=True):
    # https://download.pytorch.org/models/resnet34-333f7ec4.pth
    return ResNet(BasicBlock, [2, 2, 0, 3], num_classes=num_classes, include_top=include_top)
