...
class ResNet(nn.Module):
    ...
    def __init__(self,
        ...
        self.layer2 = self._connect_layer()
...
def BestC(num_classes=1000, include_top=True):
    # https://download.pytorch.org/models/resnet101-5d3b4d8f.pth
    return ResNet(Bottleneck, [3, 0, 23, 3], num_classes=num_classes, include_top=include_top)
