...
class ResNet(nn.Module):
    ...
    def __init__(self,
        ...
        self.layer2 = self._connect_layer1()
        self.layer3 = self._connect_layer2()
    ...
    def _connect_layer1(self):
        conv_layer3 = nn.Sequential(
            nn.Conv2d(64, 128, kernel_size=1, stride=1, bias=False),
            nn.Conv2d(128, 128, kernel_size=3, stride=2, bias=False),
            nn.BatchNorm2d(128),
            nn.ReLU(inplace=True)
        )
        self.in_channel = 128
        return nn.Sequential(conv_layer3)

    def _connect_layer2(self):
        conv_layer3 = nn.Sequential(
...
def BestB(num_classes=1000, include_top=True):
    return ResNet(BasicBlock, [2,0,0,3],num_classes=num_classes, include_top=include_top)
